...
mysqli_select_db($con,"jengaa") or die("could not select the database");
...
mysqli_query($con,"insert into contact (firstname,lastname,email,message) values('$firstname','$lastname','$email','$message')");
